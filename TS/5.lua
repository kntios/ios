                ...
                if CheckFullMail[1] == -1 then
                    ...
                    if true then
                        ...
                        if view_Suggestion then 
                            status_Video,strVideo = GetVideo(ID_Keysuggest)
                        else 
                                            ...
                                            if openVideo[1] ~= -1 then
                                                if view_Suggestion then
                                                    ...
                                                    if point_zoom[1] ~= -1 then
                                                        ...
                                                        local more = findColorsClick(6316128,550,1040,600,1100,5,true, true,rd2,5,"note")
                                                        mSleep(math.random(3000,4000))
                                                    ...
                                                    if view_Chanel then
                                                        ...
                                                        if Channel[1] ~= -1 then
                                                            local Check = findColorsClick(6710886,180,125,580,210,20,true, false,0,10+rd,"note")
                                                            mSleep(3000)
...
function StartView()
    ...
    for i=1,3 do
        local CheckLoadVD = findColorsClick(16711680,0,300,2,700,70,true, false,0,0,"note")
